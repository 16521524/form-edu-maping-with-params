        ...
        <Card className="mt-8">
          ...
          <CardContent>
            <div className="text-sm font-mono bg-muted p-4 rounded-lg overflow-x-auto">
              ...
              <code className="text-xs break-all">
                ?fullName=...&birthDate=...&gender=...&address=...&phone=...&nationalId=...&email=...&socialLink=...&eventCode=...&city=...&school=...&gradeLevel=...&academicPerformance=...&gpa=...&aspirations=...&notifyVia=...&confirmAccuracy=true
              </code>
            </div>
          </CardContent>
        </Card>
